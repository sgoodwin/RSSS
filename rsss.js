	...
	user.exists(function(exists){
		if(exists){
			user.feeds(function(array){
				...
				if(req.param('format') == 'json'){res.send(JSON.stringify(array));}
				if(req.param('format') == 'opml'){
...
/*
 ...
 @param {String} rss_url The new feed's rss url
 @param {String} html_url The new feed's homepage url
...
/*
 ...
 @param {String} rss_url (Optional) The feed's new rss url
 @param {String} html_url (Optional) The feed's new homepage url
